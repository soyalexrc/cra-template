...
import {mockCorredors, mockOperationType, mockRealStateType, mockStates} from "../../utils/mockData";

export default function PropertiesFiltersDrawer ({ open, closeAction, applyFilters, largeScreen, selectFilter, filters }) {
  return (
    <Drawer
      anchor='right'
      open={open}
    ...
    >
      <Box sx={{width: largeScreen ? 600 : 365}}>
        ...
        <Box sx={{position: largeScreen ?  'absolute' : 'relative', bottom: 0, left: 0, right: 0, mt: !largeScreen && 5}}>
