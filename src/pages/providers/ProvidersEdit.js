...
export default function ProvidersEdit() {
  ...
  return (
    <>
      <ActionBar edit action={() => navigate('/proveedores/eliminar/sample')} navigate={navigate} label='Editar Proveedor'/>
      <RootStyle title='Editar Proveedor | Alishop'>
