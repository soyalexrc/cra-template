...
export default function CategoryRegister() {
  ...
  return (
    <>
      <ActionBar navigate={navigate} label='Nueva Categoria'/>
      <RootStyle title='Registrar Categoria | Alishop'>
        ...
        <BottomMenu actions={[{label: 'Guardar', fn: () => navigate(-1), main: true, disabled: false}]}/>
      </RootStyle>
    </>
