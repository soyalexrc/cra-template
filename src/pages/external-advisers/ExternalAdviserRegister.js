...
export default function ExternalAdviserRegister() {
  ...
  return (
    <Page title='Registro de asesor | Vision Inmobiliaria'>
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} md={8}>
          <Container maxWidth='md' sx={{py: 5}}>
            <Typography variant='h5' color='secondary.light'>Datos de asesor</Typography>
            <Box display='flex' flexDirection='column' alignItems='center'>
              <Box display='flex' alignItems='center' justifyContent='center' width={100} height={100}
                   sx={{backgroundColor: '#F5F5F5', borderRadius: 100}}>
        ...
        <Grid item xs={12} sx={{display: 'flex', justifyContent: 'center'}}>
          <Button  variant='contained'>Registrar asesor externo</Button>
        </Grid>
      </Grid>
